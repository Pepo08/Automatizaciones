...
/**
 * Push CRM Scoring workflow a n8n vía REST API.
 *
 * Uso:
...
const WORKFLOW_PATH = path.join(PROJECT_DIR, 'workflows', 'crm_scoring.json');
const ID_FILE = path.join(PROJECT_DIR, '.workflow-id');
